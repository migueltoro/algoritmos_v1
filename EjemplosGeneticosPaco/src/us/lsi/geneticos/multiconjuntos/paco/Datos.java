...
public class Datos {
	...
	public static void main(String[] args) {
		iniDatos("ficheros/geneticos/multiconjuntos/multiconjuntos1.txt", true);
		iniDatos("ficheros/geneticos/multiconjuntos/multiconjuntos2.txt", true);
		iniDatos("ficheros/geneticos/multiconjuntos/multiconjuntos3.txt", true);
	}	
}
