...
public class Datos {
	...
	public record Subconjunto(Integer id, Set<Integer> elementos, Double peso) {
		public static int cont;
		public static Subconjunto parse(String s) {
			String[] v = s.split(":");
	...
	public static void iniDatos(String file, boolean show) {
		...
		for(String linea: Files2.linesFromFile(file)) {
			Subconjunto s = Subconjunto.parse(linea);
			subconjuntos.add(s);
	...
	public static void main(String[] args) {
		iniDatos("ficheros/geneticos/recubrimientoconjuntos/conjuntos2.txt", true);
	}
}