...
public class Test {
	...
	public static void main(String[] args) {
		...
		Cromosoma cr = new Cromosoma("ficheros/geneticos/equipo/equipo1.txt");
		...
		cr = new Cromosoma("ficheros/geneticos/equipo/equipo2.txt");
		...
		cr = new Cromosoma("ficheros/geneticos/equipo/equipo3.txt");
		ag = AlgoritmoAG.of(cr);
		ag.ejecuta();
