...
public class Datos {
	...
	public static void iniDatos(String file, boolean show) {
		alumnos = Files2.streamFromFile(file).map(Alumno::create).toList();
	...
	public static void toConsole() {
		...
		.collect(Collectors.joining("\n", String.format("Num. de grupos: %d\n", getNumGrupos()), "\n"));
		String2.toConsole("%s%s", s, String2.linea());
	}
	
	// Test de la lectura del fichero
	public static void main(String[] args) {
		iniDatos("ficheros/geneticos/distribucionalumnos/alumnos1.txt", true);
		iniDatos("ficheros/geneticos/distribucionalumnos/alumnos2.txt", true);
		iniDatos("ficheros/geneticos/distribucionalumnos/alumnos3.txt", true);
	}
