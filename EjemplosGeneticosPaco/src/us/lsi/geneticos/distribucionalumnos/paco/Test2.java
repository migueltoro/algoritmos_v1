...
public class Test2 {
	...
	public static void main(String[] args) {
		...
		Cromosoma2 cr = new Cromosoma2("ficheros/geneticos/distribucionalumnos/alumnos1.txt");
		...
		cr = new Cromosoma2("ficheros/geneticos/distribucionalumnos/alumnos2.txt");
		...
		cr = new Cromosoma2("ficheros/geneticos/distribucionalumnos/alumnos3.txt");
		ag = AlgoritmoAG.of(cr);
		ag.ejecuta();
